...
if (isset($_POST['submit'])){
	take_server($db_host,$db_user,$db_passwd,$db_name);
}*/
#take_api($db_host,$db_user,$db_passwd,$db_name);
...
$api_id = 4;
$take = mysqli_query($conn,"SELECT * FROM api_list where api_id = '$api_id'"); 
/* while($row = mysqli_fetch_array($take)){
    echo $row['api_id'];
    echo $row['uri'];
    echo $row['method'];
